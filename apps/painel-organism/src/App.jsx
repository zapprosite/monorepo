		...
		services: [
			{
				...
				name: 'Mem0',
				description:
					'Session memory layer. Stores conversation history with TTL (7/30/90 days) by importance. Persists via Qdrant.',
				port: ':6333',
			...
			},
			{
				...
				name: 'Qdrant',
				description:
					'Vector database for embeddings. Stores all Mem0 collections + RAG vectors. 768d nomic-embed-text vectors.',
				port: ':6333',
			...
			},
			{
				...
				name: 'Second Brain',
				description:
					'Long-term knowledge base combining Mem0 + Trieve. Layers memory by recency, importance, and domain.',
				port: ':6435',
			...
			},
			{
				...
				name: 'Redis',
				description:
					'Cache layer for rate limiting, session tokens, and ephemeral state. Zappro Redis on port 6379.',
				port: ':6379',
		...
		services: [
			{
				...
				name: 'Trieve',
				description:
					'RAG dataset organizer. Manages knowledge chunks by dimension (app, lead, knowledge). Handles hybrid search.',
				port: ':6435',
			...
			},
			{
				...
				name: 'RAG Pipeline',
				description:
					'ragRetrieve + ragSearch tools in Hermes Agency. Uses Trieve for semantic search + Qdrant for vector matching.',
				port: ':3001',
				docs: 'docs/RAG_ARCHITECTURE.md',
			...
			},
			{
				...
				name: 'Embeddings',
				description:
					'Ollama nomic-embed-text generates 768d vectors. Used by Mem0 for session memory and Trieve for RAG.',
				port: ':11434',
		...
		services: [
			{
				...
				name: 'LiteLLM Proxy',
				description:
					'Multi-provider LLM gateway. Routes to MiniMax → Groq → OpenAI → Ollama. Handles retries, fallbacks, cost tracking.',
				port: ':4000',
				docs: 'docs/LLM_PROVIDER_ARCHITECTURE.md',
			...
			},
			{
				...
				name: 'Ollama',
				description:
					'Local LLM inference on RTX 4090. Models: gemma4, qwen2.5vl, nomic-embed-text. Zero external API cost.',
				port: ':11434',
				docs: null,
				healthUrl: 'http://localhost:11434/api/tags',
				url: null,
			},
			{
				...
				name: 'ai-gateway',
				description:
					'OpenAI-compatible facade. Routes to LiteLLM. Bearer token auth. Serves llm.zappro.site.',
				port: ':4002',
			...
			},
			{
				...
				name: 'MiniMax',
				description:
					'Primary external LLM provider. Used for CEO routing, creative tasks, and high-quality generation.',
				port: 'API',
				docs: null,
				healthUrl: null,
				url: null,
		...
		services: [
			{
				...
				name: 'Hermes Agency',
				description:
					'CEO_REFRIMIX_bot — multi-skill marketing agent. Routes user messages via CEO LLM to 12 skills (creative, social, analytics, onboarding...).',
				port: ':3001',
				docs: 'docs/HERMES-OPS.md',
				healthUrl: 'http://localhost:3001/health',
				url: 'https://hermes-agency.zappro.site',
			},
			{
				...
				name: 'Claude Code',
				description:
					'Main coding agent. Reads/writes code, runs tests, commits. Part of the organism CLI tooling.',
				port: 'CLI',
				docs: null,
				healthUrl: null,
				url: null,
			},
			{
				...
				name: 'mclaude',
				description:
					'Multi-provider LLM switcher CLI. Switch between MiniMax, Ollama, Groq, OpenAI, LiteLLM at runtime.',
				port: 'CLI',
				docs: null,
				healthUrl: null,
				url: null,
			},
			{
				...
				name: 'OpenCode',
				description:
					'Web scraping + AI research agent. Uses SearXNG for search, processes results via LLM.',
				port: ':4013',
				docs: null,
				healthUrl: null,
				url: null,
		...
		services: [
			{
				...
				name: 'Telegram Bot',
				description:
					'Hermes Telegram integration. Users chat with CEO_REFRIMIX_bot via Telegram. Voice messages processed via Kokoro-TTS.',
				port: ':8642',
			...
			},
			{
				...
				name: 'OpenWebUI',
				description:
					'Chat UI for LLM interaction. Users chat with local models via OpenWebUI. Serves chat.zappro.site.',
				port: ':8080',
				docs: null,
				healthUrl: null,
			...
			},
			{
				...
				name: 'Grafana',
				description:
					'Monitoring dashboards. Shows metrics for Hermes, LiteLLM, Qdrant, Redis, Ollama. Alerting configured.',
				port: ':3000',
			...
			},
			{
				...
				name: 'Coolify',
				description:
					'Container orchestration PaaS. Manages all Docker deployments, SSL, health checks, and rollback.',
				port: ':8000',
				docs: null,
				healthUrl: null,
		...
		services: [
			{
				...
				name: 'PostgreSQL MCP',
				description:
					'Structured database via MCP server (port 4017). Schema: clients, campaigns, tasks, deliverables, metrics. Syncs to Qdrant.',
				port: ':4017',
			...
			},
			{
				...
				name: 'Gitea',
				description:
					'Self-hosted Git server. Hosts all git repos including monorepo. Accessible via git.zappro.site.',
				port: ':3300',
				docs: null,
				healthUrl: null,
			...
			},
			{
				...
				name: 'ZFS Pool',
				description:
					'tank pool (3.5TB, 99% free). Datasets: monorepo, qdrant, models, backups, docker-data. Snapshots for backup.',
				port: 'ZFS',
				docs: null,
				healthUrl: null,
				url: null,
		...
		services: [
			{
				...
				name: 'Docker',
				description:
					'Container runtime. 31 containers running across multiple networks (bridge, coolify, litellm_default...).',
				port: 'Docker',
			...
			},
			{
				...
				description:
					'Secure tunnel to expose services. No direct IP exposure. Tunnel ID aee7a93d-c2e2-4c77-a395-71edc1821402.',
				port: 'cloudflared',
			...
			},
			{
				...
				name: 'MCP Servers',
				description:
					'7 MCP servers (4011-4017): Qdrant, Coolify, Ollama, System, Cron, Memory, Postgres. Claude Code tool access.',
				port: '4011-4017',
			...
			},
			{
				...
				name: 'Monorepo',
				description:
					'Central git repo at /srv/monorepo. All apps, configs, docs, scripts, agents. Git worktrees for parallel work.',
				port: '/srv/monorepo',
				docs: null,
				healthUrl: null,
			...
			<header className="relative min-h-screen flex flex-col items-center justify-center gradient-hero overflow-hidden">
				...
				<div className="relative z-10 text-center px-4">
					...
					<div className="flex gap-4 justify-center flex-wrap">
						<a
							href="#memory"
							className="px-6 py-3 bg-neon-cyan text-dark-900 font-bold rounded-lg hover:bg-neon-cyan/90 transition-all shadow-neon-cyan"
						>
							Explorar Camadas
						</a>
						<a
							href="https://git.zappro.site/will-zappro/monorepo"
							target="_blank"
							rel="noopener noreferrer"

...
- [ ] T1.1: Criar dirs `/srv/data//{gemini,perplexity}` (PUID 1000:1000 ✅ játem)
- [ ] T1.2: Verificar PUID ✅ (1000:1000 confirmado)
- [ ] T1.3: Atualizar SPEC-007 com bind mount pattern do 

## Phase 2: OAuth Automation
- [ ] T2.1: Criar `oauth-auto-login.js` — CDP + storageState
- [ ] T2.2: Integrar (GEMINI_EMAIL/PERPLEXITY_EMAIL)
...
- [ ] T4.4: Criar smoke test `tests/.sh`

...
| aurelia-net | 10.0.8.0/24 | 10.0.8.1 | local |
...
| hermes-agency | 10.0.8.4, 10.0.9.3 | aurelia-net, platform_default | Yes (NAT) |
...
| zappro-redis | 10.0.8.2, 10.0.2.3 | aurelia-net, zappro-lite_default | Yes (NAT) |
...
- **Cross-network communication**: Services like `hermes-agency` (aurelia-net + platform_default) act as bridges between networks.
...
| hermes-agency | platform_default | 10.0.9.3 |
| coolify-redis | coolify | 10.0.0.2:6379 |
| zappro-redis | aurelia-net | 10.0.8.2:6379 |

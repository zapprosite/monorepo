...
│  │     Important: n8n, , gitea, postgres-*, redis-*
│  │     Standard: , browsers, searxng, cadvisor, node-exporter
│  │
...
| Important | n8n, , gitea, postgres-*, redis-* | Restart if RestartCount < 3 |
| Standard | , browsers, searxng, cadvisor, node-exporter | Restart if RestartCount < 3 |

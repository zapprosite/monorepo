...
| `OPENCLAW_CONTAINER` | `6771lt8l7x8rqx72f` |
...
============================================================
✅ shared_network_coolify-proxy_6771lt8l7x8rqx72f shared: qgtzrmi6771lt8l7x8rqx72f
✅ tcp_zappro-litellm_wav2vec2_8201 connected to wav2vec2:8201
❌ shared_network_traefik_: no shared network
============================================================
OVERALL: FAIL
```
...
```json
{
  ...
  "checks": [
    {
      "name": "shared_network_coolify-proxy_6771lt8l7x8rqx72f",
      "status": "PASS",
...
Verifica rotas Traefik → :

1. Shared network coolify-proxy ↔ 
2. TCP connectivity Traefik → 
3. HTTP health from Traefik to 

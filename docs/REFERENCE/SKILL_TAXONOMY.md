...
│  Examples: create_task, update_task_status, rag_rehaystack    │
├─────────────────────────────────────────────────────────────┤
│  LEVEL 2: REAL (Basic)                                      │
...
| `qdrant_rehaystack` | agency-creative | 3 | Qdrant semantic search |
...
| `rag_rehaystack` | rag-instance-organizer | 3 | Qdrant semantic search |

...
- `docs/SPECS/SPEC-012-ecosystem-architecture.md` → `https://git.zappro.site/will-zappro/monorepo/raw/HEAD/docs/SPECS/SPEC-012-ecosystem-architecture.md`
...
| Key | Servico | Porta | Health URL | Docs |
|-----|---------|-------|------------|------|
| `haystack` | Haystack | `:6435` | `http://localhost:6435/api/v1/health` | `docs/RAG_ARCHITECTURE.md` |
...
|-----|---------|-------|------------|-----|------|
| `litellm` | LiteLLM Proxy | `:4000` | `http://localhost:4018/health` | `https://llm.zappro.site` | `docs/LLM_PROVIDER_ARCHITECTURE.md` |
...
| `mcp-servers` | MCP Servers | `4011-4017` | — | `docs/SPECS/SPEC-012-ecosystem-architecture.md` |
...
| LiteLLM | `http://localhost:4018/health` | 401 (auth required — esperado) |
...
| Haystack | `http://localhost:6435/api/v1/health` | `{"status":"ok"}` |

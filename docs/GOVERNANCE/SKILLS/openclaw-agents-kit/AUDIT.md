...
### Problema C: TTS Bridge URL sem documentação

Resolvido no template: `OPENAI_TTS_BASE_URL` deve apontar para `http://10.0.19.5:8013/v1` (TTS Bridge) e NÃO pode ser Kokoro direto (`:8880`).

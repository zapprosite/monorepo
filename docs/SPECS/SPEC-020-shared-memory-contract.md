...
**Goal:** Eliminate silos — any agent can read/write memory that other agents can rehaystack.
...
- [SPEC-002](SPEC-002-homelab-control-plane.md) — Hermes Agent Runtime (router)
- [SPEC-003](SPEC-020.md) — Memory RAG LLM Stack (Qdrant, LiteLLM, embedding contract)

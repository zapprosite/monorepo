# SPEC-028 — Hvac Field Expertise
— HVAC Field Expertise Memory
...
- **SPEC-028** = Qdrant payload filtering para manuais (`hvac_manuals_v1`)
- **SPEC-028-hvac-field-expertise** = memória de campo e expertise profissional (`hvac_field_experience_v1`)
...
| Teste | Descrição |
|-------|-----------|
| `test_daikin_vrv_u4_01_vee_rehaystacks_fieldcase` | Daikin VRV U4-01 + VEE recupera fieldcase do willrefrimix |

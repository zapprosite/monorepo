...
3. **Env var mismatches**: 5 containers com valores diferentes do `.env` - requires correction
...
4. **Monitor mcp-memory**: embedding errors são intermitentes (~4 occurrences) - may be caused by LiteLLM timeout vs. network isolation

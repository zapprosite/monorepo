...
| **GPU Max + Cloud Fallback** | SPEC-055-v2 ✅                                          | [SPEC-055-v2-gpu-max-latra-inteligent-cloud-fallback.md](./SPEC-055-v2-gpu-max-latra-inteligent-cloud-fallback.md) | whisper + Kokoro + Gemma4-12b-it (text) + qwen2.5vl:7b (future), GROQ/Deepgram free tiers |
...
| SPEC-055-v2 | GPU Max + Cloud Fallback         | whisper-medium-pt + Kokoro + Gemma4-12b-it (text) + qwen2.5vl:7b (future), GROQ/Deepgram free tiers VRAM-aware fallback  |
...
GPU max + cloud fallback     → SPEC-055-v2

...
### 5.3 Ollama LLM Models

**Role:** Code generation, vision, and embeddings for agent execution

| Model | Size | Purpose | Endpoint |
|-------|------|---------|----------|
| `qwen2.5-coder:14b-q6k` | 14B | **Code Generation** (primary for E phase) | Ollama :11434 |
| `qwen2.5vl:3b` | 3B | Vision STT (image analysis) | Ollama :11434 |
| `nomic-embed-text:latest` | — | Embeddings for vector search | Ollama :11434 |

**Usage in PREVC:**
- **Phase E (Execute):** `qwen2.5-coder:14b-q6k` for code generation tasks
- **Vision tasks:** `qwen2.5vl:3b` for image analysis
- **Memory/RAG:** `nomic-embed-text` for semantic search

**Agent Model Selection:**
```
code-reviewer, feature-developer, bug-fixer → qwen2.5-coder:14b (code generation)
Any agent with vision input → qwen2.5vl:3b
```

### 5.4 vibe-kit (Execution Loop)

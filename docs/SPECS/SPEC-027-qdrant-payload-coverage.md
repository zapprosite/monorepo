...
**Owner:** SRE/homelab
spec: SPEC-027-qdrant-payload-coverage
...
# SPEC-027 — Qdrant Payload Coverage
— Qdrant Payload-Filtered Coverage for Universal Resolver
...
---
Parent: SPEC-027 (HVAC Universal Resolver)

...
**Owner:** SRE/homelab
name: SPEC-010-homelab-governance
...
# SPEC-010-homelab-governance — Datacenter Enterprise Pattern
...
```
□ 1. Ler este documento (SPEC-010-homelab-governance.md)

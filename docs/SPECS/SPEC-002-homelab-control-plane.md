...
# SPEC-002 — Homelab Control Plane
...
- Qdrant, Mem0, Haystack RAG, Ollama, LiteLLM, Redis, and PostgreSQL MCP.
...
| Knowledge | Haystack + Qdrant | Docs/specs/runbooks retrieval |
...
| Haystack | `HAYSTACK_URL` | `6435` | RAG API |
...
- `apps/hermes-gateway/src/skills/rag-instance-organizer.ts` integrates Haystack.

...
**Owner:** SRE/homelab
spec: SPEC-203
title: Diagnóstico e Restart zappro-litellm (:4018)
status: pending
date: 2026-04-24
author: SRE Session
---

# SPEC-203 — Diagnóstico e Restart zappro-litellm (:4018)

## Sintoma

zappro-litellm na porta `:4018` pode estar down ou não respondendo.
...
# 3. Health check
curl http://127.0.0.1:4018/health

...
Executado antes da geracao do plano para enriquecer contexto:

```bash
# Query Mem0 para preferencias e padroes
python3 /srv/monorepo/scripts/mem0_wrapper.py search "<brief>"
...
**Output:** Contexto concatenado para o prompt de geracao

...
### Fase 2: Reorganize Docs (EXECUTADO 2026-05-02)
- Batch 4: REORG docs/ ✅ EXECUTADO
  - 71 arquivos movidos do root para subdirs
  - 4 pares de dirs duplicados por case eliminados (specs/SPECS, adr/ADRs, guides/GUIDES, ops/OPS)
  - 5 SPECs orfaos movidos para SPECS/
  - 7 docs de governance sincronizados (ops/ai-governance/ --> docs/GOVERNANCE/)
  - docs/GOVERNANCE/ agora espelha ops/ai-governance/ (fonte canonica)
  - Structure final: 455 .md em 30 subdiretorios, 2 arquivos no root (README + index)
  - ops/ops symlink loop removido

...
# SPEC-018 — Qdrant Auth Strategy
— Qdrant Authentication Strategy
...
- Go Client: `github.com/qdrant/go-client/qdrant`
- SPEC-009 Shadow Context Blueprint (parent): `/srv/monorepo/docs/SPECS/SPEC-006-multi-agent-architecture.md`

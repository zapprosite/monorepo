...
# SPEC-012 — Ecosystem Architecture
— Hermes Ecosystem: Arquitetura Enterprise Standard
...
| P0-LITELLM | Verificar zappro-litellm status (:4018) | ALTA |

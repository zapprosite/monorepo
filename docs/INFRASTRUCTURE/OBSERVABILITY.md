...
| Haystack | :6435 | HTTP | planned | RAG as a Service |
...
- Chunk Counts: sum by dataset (haystack_chunks_total)
- Search Result Sizes: avg by dataset (haystack_search_results_count)
```

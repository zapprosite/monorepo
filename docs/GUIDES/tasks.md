...
- [ ] **[SPEC-016:AC-1]** Configurar cron `*/5 * * * *` para smoke-test-loop.sh — verificar com `crontab -l | grep smoke`
- [ ] **[SPEC-016:AC-3]** Implementar auto-heal: Service DOWN → `docker start`
...
- [ ] **[SPEC-016:AC-5]** Verificar logs em `/srv/monorepo/logs/smoke-tests/` — `ls -la logs/smoke-tests/`
...
|------|--------|------------|
| SPEC-016 | Auto-Healer Cursor-Loop | critical |

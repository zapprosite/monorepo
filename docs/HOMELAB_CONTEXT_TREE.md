...
- **`zappro-ai-gateway`** — `ai-gateway:dev-20260503` (0.0.0.0:4002->4002/tcp, [::]:4002->4002/tcp)
...
- **`hermes-orchestrator`** — `python:3.11-slim` (no ports)
...
- **`zappro-gitea`** — `gitea/gitea:latest` (127.0.0.1:2222->22/tcp, 127.0.0.1:3300->3000/tcp)
- **`zappro-pgadmin`** — `dpage/pgadmin4:latest` (443/tcp, 127.0.0.1:4050->80/tcp)
- **`hermes-second-brain-qdrant-1`** — `qdrant/qdrant:v1.17.1` (127.0.0.1:6333-6334->6333-6334/tcp)
...
- **`zappro-litellm-db`** — `postgres:15-alpine` (5432/tcp)
- **`zappro-redis`** — `redis:7.2.4-alpine` (127.0.0.1:6379->6379/tcp)
- **`zappro-edge-tts`** — `edge-tts-edge-tts` (127.0.0.1:8012->8015/tcp)

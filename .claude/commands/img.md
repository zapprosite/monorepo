...
Analisa imagem com Qwen2.5-VL local via Ollama.
...
4. Envia para Qwen2.5-VL via POST /api/generate
5. Retorna a descrição em português

Se a imagem não existir ou Qwen2.5-VL falhar, reporta o erro específico.

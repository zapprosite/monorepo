...
- [ ] **[SPEC-016:AC-1]** Configurar cron `*/5 * * * *` para .sh — verificar com `crontab -l | grep `
...
- [ ] **[SPEC-020:AC-2]** Atualizar openwebui_mcp.py com tool `_bridge_chat`
- [ ] **[SPEC-020:AC-3]** Atualizar _mcp_wrapper.py com tool `chat_with_agent`
...
- [ ] **[SPEC-016:AC-5]** Verificar logs em `/srv/monorepo/logs//` — `ls -la logs//`

...
export const subscriptionCreateInputZod = subscriptionMandatoryZod.extend(
	subscriptionOptionalZod.partial().shape,
);
export type SubscriptionCreateInput = z.infer<typeof subscriptionCreateInputZod>;

export const subscriptionUpdateInputZod = subscriptionMandatoryZod
	.extend(subscriptionOptionalZod.shape)
	.extend(zTimestamps)
	.partial();
export type SubscriptionUpdateInput = z.infer<typeof subscriptionUpdateInputZod>;

export const subscriptionSelectAllZod = subscriptionMandatoryZod
	.extend(subscriptionOptionalZod.shape)
	.extend(subscriptionAutoGeneratedZod.shape)
	.extend(zTimestamps);

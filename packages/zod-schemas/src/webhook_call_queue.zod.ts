...
export const webhookCallQueueCreateInputZod = webhookCallQueueMandatoryZod.extend(
	webhookCallQueueOptionalZod.partial().shape,
);
export type WebhookCallQueueCreateInput = z.infer<typeof webhookCallQueueCreateInputZod>;

export const webhookCallQueueUpdateInputZod = webhookCallQueueMandatoryZod
	.extend(webhookCallQueueOptionalZod.shape)
	.extend(zTimestamps)
	.partial();
export type WebhookCallQueueUpdateInput = z.infer<typeof webhookCallQueueUpdateInputZod>;

export const webhookCallQueueSelectAllZod = webhookCallQueueMandatoryZod
	.extend(webhookCallQueueOptionalZod.shape)
	.extend(zTimestamps)
	.extend(webhookCallQueueAutoGeneratedZod.shape);
export type WebhookCallQueueSelectAll = z.infer<typeof webhookCallQueueSelectAllZod>;

export const webhookCallQueueGetByIdInputZod = webhookCallQueueAutoGeneratedZod;

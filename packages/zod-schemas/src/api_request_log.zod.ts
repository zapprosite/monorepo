...
export const apiProductRequestLogCreateInputZod = apiProductRequestLogMandatoryZod.extend(
	apiProductRequestOptionalZod.partial().shape,
);
export type ApiProductRequestLogCreateInput = z.infer<typeof apiProductRequestLogCreateInputZod>;

export const apiProductRequestLogUpdateInputZod = apiProductRequestLogMandatoryZod
	.extend(apiProductRequestOptionalZod.shape)
	.extend(zTimestamps)
	.partial();
export type ApiProductRequestLogUpdateInput = z.infer<typeof apiProductRequestLogUpdateInputZod>;

export const apiProductRequestLogSelectAllZod = apiProductRequestLogMandatoryZod
	.extend(apiProductRequestOptionalZod.shape)
	.extend(zTimestamps)
	.extend(apiProductRequestLogAutoGeneratedZod.shape);
...
export type ApiProductRequestLogGetByTeamInput = z.infer<
	typeof apiProductRequestLogGetByTeamInputZod
>;

...
export const promptUpdateInputZod = promptMandatoryZod
	.extend(promptOptionalZod.shape)
	.extend(zTimestamps)
	.partial();
export type PromptUpdateInput = z.infer<typeof promptUpdateInputZod>;

export const promptSelectAllZod = promptMandatoryZod
	.extend(promptOptionalZod.shape)
	.extend(zTimestamps)
	.extend(promptAutoGeneratedZod.shape);

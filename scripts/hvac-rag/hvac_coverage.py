...
Evidence Levels (priority order):
    ...
    7. llm_triage       — OpenRouter via nexus-brain provides safe triage without exact data
...
def _describe_evidence_level(level: str) -> str:
    ...
    descriptions = {
        ...
        "llm_triage": "OpenRouter via nexus-brain can provide safe triage based on general knowledge",
